...
import { ProfileActivation } from './ProfileActivation.tsx'
import { AlarmMarker } from './AlarmMarker.tsx'
...
export const GraphMarker = ({ config, point, isSelected, setSelected }: Props) => {
  ...
  return (
    ...
    >
      ...
      <ProfileActivation point={point} />

      <AlarmMarker point={point} isSelected={isSelected} />
    </div>
  )
}
