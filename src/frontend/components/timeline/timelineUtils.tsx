import { HOUR_IN_MS, roundTo1Decimals } from 'shared/calculations/calculations';
...
export const getExtendedTimelineConfig = (c: TimelineConfig): ExtendedTimelineConfig => {
...
export const tsToLeft = (c: ExtendedTimelineConfig, ts: number) => {
  return roundTo1Decimals(c.paddingLeft + (ts - (c.timelineRangeEnd - c.timelineRange)) * c.pixelsPerMs);
};

// Inverse of tsToLeft()
export const leftToTs = (c: ExtendedTimelineConfig, left: number) => {
