import { TimelineModel, TimelineModelType } from 'shared/models/model';
...
import {
  ...
  PREFIX_GLOBAL,
  PREFIX_TIMELINE,
} from 'shared/storage/couchDbStorage';
import PouchDB from 'shared/storage/PouchDb';
import { Storage } from 'shared/storage/storage';
import { reject } from 'shared/utils/promise';
import { debounce, flatten } from 'lodash';
import { DateTime } from 'luxon';
import { actions, ReduxAction } from 'frontend/data/actions';
import { ReplicationDirection } from 'frontend/data/pouchDb/state';
import { createChangeObserver, ReduxDispatch, ReduxMiddleware } from 'frontend/utils/redux';
  ...
  return next => {
    ...
    observer.add(
      state =>
        ...
        (state.navigation.selectedScreen === 'Stats' || state.navigation.selectedScreen === 'BgGraph')
          ? ([
