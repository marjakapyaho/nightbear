...
const createProfileTemplateIR: any = {
  usedParamSet: {
    profileName: true,
    alarmsEnabled: true,
    analyserSettingsId: true,
    situationSettingsId: true,
  ...
  params: [
    ...
    {
      name: 'analyserSettingsId',
      required: true,
      transform: { type: 'scalar' },
      locs: [{ a: 196, b: 215 }],
    },
    {
      name: 'situationSettingsId',
      required: true,
      transform: { type: 'scalar' },
      locs: [{ a: 220, b: 240 }],
    },
...
const createAnalyserSettingsIR: any = {
  usedParamSet: {
    highLevelRel: true,
    highLevelAbs: true,
    highLevelBad: true,
 ...
 * ```
 */
export const createAnalyserSettings = new PreparedQuery<
  ICreateAnalyserSettingsParams,
  ICreateAnalyserSettingsResult
>(createAnalyserSettingsIR);

/** Query 'CreateSituationSettings' is invalid, so its result is assigned type 'never'.
 *  */
export type ICreateSituationSettingsResult = never;

/** Query 'CreateSituationSettings' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ICreateSituationSettingsParams = never;

const createSituationSettingsIR: any = {
  usedParamSet: {
    outdated: true,
  ...
  params: [
    { name: 'outdated', required: true, transform: { type: 'scalar' }, locs: [{ a: 176, b: 185 }] },
    {
    ...
    { name: 'falling', required: true, transform: { type: 'scalar' }, locs: [{ a: 214, b: 222 }] },
    { name: 'rising', required: true, transform: { type: 'scalar' }, locs: [{ a: 228, b: 235 }] },
    { name: 'low', required: true, transform: { type: 'scalar' }, locs: [{ a: 241, b: 245 }] },
    { name: 'badLow', required: true, transform: { type: 'scalar' }, locs: [{ a: 251, b: 258 }] },
    {
      name: 'compressionLow',
      required: true,
      transform: { type: 'scalar' },
    ...
    { name: 'high', required: true, transform: { type: 'scalar' }, locs: [{ a: 285, b: 290 }] },
    { name: 'badHigh', required: true, transform: { type: 'scalar' }, locs: [{ a: 296, b: 304 }] },
    {
      name: 'persistentHigh',
      required: true,
      transform: { type: 'scalar' },
 ...
 * ```
 */
export const createSituationSettings = new PreparedQuery<
  ICreateSituationSettingsParams,
  ICreateSituationSettingsResult
>(createSituationSettingsIR);
...
/** Query 'GetProfiles' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetProfilesResult = never;

/** Query 'GetProfiles' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetProfilesParams = never;
...
const getRelevantProfileActivationsIR: any = {
  usedParamSet: {},
  params: [],
  statement:
 ...
 * ```
 */
export const getRelevantProfileActivations = new PreparedQuery<
  IGetRelevantProfileActivationsParams,
  IGetRelevantProfileActivationsResult
>(getRelevantProfileActivationsIR);
...
const reactivateProfileActivationIR: any = {
  usedParamSet: { id: true },
  params: [{ name: 'id', required: true, transform: { type: 'scalar' }, locs: [{ a: 77, b: 80 }] }],
  statement:
 ...
 * ```
 */
export const reactivateProfileActivation = new PreparedQuery<
  IReactivateProfileActivationParams,
  IReactivateProfileActivationResult
>(reactivateProfileActivationIR);
