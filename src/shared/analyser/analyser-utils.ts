import { MIN_IN_MS, roundTo2Decimals, TIME_LIMIT_FOR_SLOPE } from 'shared/calculations/calculations';
import { AnalyserEntry, Insulin, SensorEntry } from 'shared/models/model';
