 ...
 * ```
 */
exports.getProfiles = new runtime_1.PreparedQuery(getProfilesIR);
const createProfileActivationIR = { "usedParamSet": { "profileTemplateId": true, "activatedAt": true, "deactivatedAt": true }, "params": [{ "name": "profileTemplateId", "required": true, "transform": { "type": "scalar" }, "locs": [{ "a": 102, "b": 120 }] }, { "name": "activatedAt", "required": true, "transform": { "type": "scalar" }, "locs": [{ "a": 124, "b": 136 }] }, { "name": "deactivatedAt", "required": false, "transform": { "type": "scalar" }, "locs": [{ "a": 140, "b": 153 }] }], "statement": "INSERT INTO profile_activations (\n  profile_template_id,\n  activated_at,\n  deactivated_at\n)\nVALUES (\n :profileTemplateId!,\n :activatedAt!,\n :deactivatedAt\n)\nRETURNING *" };
/**
 * Query generated from SQL:
 * ```
 ...
 * ```
 */
exports.createProfileActivation = new runtime_1.PreparedQuery(createProfileActivationIR);
const getLatestProfileActivationIR = { "usedParamSet": {}, "params": [], "statement": "SELECT\n  profile_activations.id,\n  profile_template_id,\n  activated_at,\n  deactivated_at,\n  profile_templates.profile_name\nFROM profile_activations\n  INNER JOIN profile_templates ON profile_templates.id = profile_activations.profile_template_id\nORDER BY activated_at DESC\nLIMIT 1" };
/**
 * Query generated from SQL:
 * ```
 * SELECT
 ...
 * ```
 */
exports.getLatestProfileActivation = new runtime_1.PreparedQuery(getLatestProfileActivationIR);
const getProfileActivationByIdIR = { "usedParamSet": { "id": true }, "params": [{ "name": "id", "required": true, "transform": { "type": "scalar" }, "locs": [{ "a": 276, "b": 279 }] }], "statement": "SELECT\n  profile_activations.id,\n  profile_template_id,\n  activated_at,\n  deactivated_at,\n  profile_templates.profile_name\nFROM profile_activations\n  INNER JOIN profile_templates ON profile_templates.id = profile_activations.profile_template_id\nWHERE profile_activations.id = :id!" };
/**
 * Query generated from SQL:
 * ```
 * SELECT
 ...
 * ```
 */
exports.getProfileActivationById = new runtime_1.PreparedQuery(getProfileActivationByIdIR);
const getProfileActivationsByTimestampIR = { "usedParamSet": { "from": true, "to": true }, "params": [{ "name": "from", "required": true, "transform": { "type": "scalar" }, "locs": [{ "a": 267, "b": 272 }] }, { "name": "to", "required": false, "transform": { "type": "scalar" }, "locs": [{ "a": 303, "b": 305 }] }], "statement": "SELECT\n  profile_activations.id,\n  profile_template_id,\n  activated_at,\n  deactivated_at,\n  profile_templates.profile_name\nFROM profile_activations\n  INNER JOIN profile_templates ON profile_templates.id = profile_activations.profile_template_id\nWHERE activated_at >= :from! AND activated_at <= COALESCE(:to, CURRENT_TIMESTAMP)" };
/**
 * Query generated from SQL:
 * ```
 * SELECT
 ...
 * ```
 */
exports.getProfileActivationsByTimestamp = new runtime_1.PreparedQuery(getProfileActivationsByTimestampIR);
//# sourceMappingURL=profiles.queries.js.map