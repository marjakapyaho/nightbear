 ...
 * ```
 */
export const createSensorEntry = new PreparedQuery<
  ICreateSensorEntryParams,
  ICreateSensorEntryResult
>(createSensorEntryIR)
...
const createSensorEntriesIR: any = {
  usedParamSet: { sensorEntries: true },
  params: [
    {
      name: 'sensorEntries',
      required: false,
 ...
 * ```
 */
export const createSensorEntries = new PreparedQuery<
  ICreateSensorEntriesParams,
  ICreateSensorEntriesResult
>(createSensorEntriesIR)
...
const getSensorEntriesByTimestampIR: any = {
  usedParamSet: { from: true, to: true },
  params: [
    { name: 'from', required: true, transform: { type: 'scalar' }, locs: [{ a: 48, b: 53 }] },
    { name: 'to', required: false, transform: { type: 'scalar' }, locs: [{ a: 81, b: 83 }] },
  ],
  statement:
 ...
 * ```
 */
export const getSensorEntriesByTimestamp = new PreparedQuery<
  IGetSensorEntriesByTimestampParams,
  IGetSensorEntriesByTimestampResult
>(getSensorEntriesByTimestampIR)
...
const getLatestSensorEntryIR: any = {
  usedParamSet: {},
  params: [],
 ...
 * ```
 */
export const getLatestSensorEntry = new PreparedQuery<
  IGetLatestSensorEntryParams,
  IGetLatestSensorEntryResult
>(getLatestSensorEntryIR)
