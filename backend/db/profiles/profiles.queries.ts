/** Types generated for queries found in "db/profiles/profiles.sql" */
...
const createProfileTemplateIR: any = {
  usedParamSet: {
    profileName: true,
    alarmsEnabled: true,
    repeatTimeInLocalTimezone: true,
    ...
    lowLevelRel: true,
    lowLevelAbs: true,
    timeSinceBgMinutes: true,
    outdated: true,
    criticalOutdated: true,
    falling: true,
    rising: true,
    low: true,
    badLow: true,
  ...
  params: [
    ...
    {
      name: 'repeatTimeInLocalTimezone',
      required: false,
      transform: { type: 'scalar' },
      locs: [{ a: 600, b: 625 }],
    },
    ...
    {
      name: 'timeSinceBgMinutes',
      required: true,
      transform: { type: 'scalar' },
      locs: [{ a: 743, b: 762 }],
    },
    { name: 'outdated', required: true, transform: { type: 'scalar' }, locs: [{ a: 767, b: 776 }] },
    {
      name: 'criticalOutdated',
      required: true,
      transform: { type: 'scalar' },
      locs: [{ a: 781, b: 798 }],
    },
    { name: 'falling', required: true, transform: { type: 'scalar' }, locs: [{ a: 803, b: 811 }] },
    { name: 'rising', required: true, transform: { type: 'scalar' }, locs: [{ a: 816, b: 823 }] },
    { name: 'low', required: true, transform: { type: 'scalar' }, locs: [{ a: 828, b: 832 }] },
    { name: 'badLow', required: true, transform: { type: 'scalar' }, locs: [{ a: 837, b: 844 }] },
    {
      name: 'compressionLow',
      required: true,
      transform: { type: 'scalar' },
    ...
    { name: 'high', required: true, transform: { type: 'scalar' }, locs: [{ a: 869, b: 874 }] },
    { name: 'badHigh', required: true, transform: { type: 'scalar' }, locs: [{ a: 879, b: 887 }] },
    {
      name: 'persistentHigh',
      required: true,
      transform: { type: 'scalar' },
 ...
 * ```
 */
export const createProfileTemplate = new PreparedQuery<
  ICreateProfileTemplateParams,
  ICreateProfileTemplateResult
>(createProfileTemplateIR)
...
const editProfileTemplateIR: any = {
  usedParamSet: {
    profileName: true,
    alarmsEnabled: true,
    repeatTimeInLocalTimezone: true,
  ...
  params: [
    ...
    { name: 'outdated', required: true, transform: { type: 'scalar' }, locs: [{ a: 502, b: 511 }] },
    {
      name: 'criticalOutdated',
      required: true,
      transform: { type: 'scalar' },
    ...
    { name: 'falling', required: true, transform: { type: 'scalar' }, locs: [{ a: 588, b: 596 }] },
    { name: 'rising', required: true, transform: { type: 'scalar' }, locs: [{ a: 620, b: 627 }] },
    { name: 'low', required: true, transform: { type: 'scalar' }, locs: [{ a: 648, b: 652 }] },
    { name: 'badLow', required: true, transform: { type: 'scalar' }, locs: [{ a: 677, b: 684 }] },
    {
      name: 'compressionLow',
      required: true,
      transform: { type: 'scalar' },
    ...
    { name: 'high', required: true, transform: { type: 'scalar' }, locs: [{ a: 754, b: 759 }] },
    { name: 'badHigh', required: true, transform: { type: 'scalar' }, locs: [{ a: 785, b: 793 }] },
    {
      name: 'persistentHigh',
      required: true,
      transform: { type: 'scalar' },
    ...
    { name: 'id', required: true, transform: { type: 'scalar' }, locs: [{ a: 909, b: 912 }] },
  ],
  statement:
 ...
 * ```
 */
export const editProfileTemplate = new PreparedQuery<
  IEditProfileTemplateParams,
  IEditProfileTemplateResult
>(editProfileTemplateIR)
...
const getProfilesIR: any = {
  usedParamSet: { templateId: true, onlyActive: true },
  params: [
    {
      name: 'templateId',
      required: false,
...
const createProfileActivationIR: any = {
  usedParamSet: { profileTemplateId: true, activatedAt: true, deactivatedAt: true },
  params: [
    {
 ...
 * ```
 */
export const createProfileActivation = new PreparedQuery<
  ICreateProfileActivationParams,
  ICreateProfileActivationResult
>(createProfileActivationIR)
...
const getLatestProfileActivationIR: any = {
  usedParamSet: {},
  params: [],
  statement:
 ...
 * ```
 */
export const getLatestProfileActivation = new PreparedQuery<
  IGetLatestProfileActivationParams,
  IGetLatestProfileActivationResult
>(getLatestProfileActivationIR)
...
const getProfileActivationByIdIR: any = {
  usedParamSet: { id: true },
  params: [
    { name: 'id', required: true, transform: { type: 'scalar' }, locs: [{ a: 276, b: 279 }] },
  ],
  statement:
 ...
 * ```
 */
export const getProfileActivationById = new PreparedQuery<
  IGetProfileActivationByIdParams,
  IGetProfileActivationByIdResult
>(getProfileActivationByIdIR)
...
const getProfileActivationsByTimestampIR: any = {
  usedParamSet: { from: true, to: true },
  params: [
    { name: 'from', required: true, transform: { type: 'scalar' }, locs: [{ a: 267, b: 272 }] },
    { name: 'to', required: false, transform: { type: 'scalar' }, locs: [{ a: 303, b: 305 }] },
  ],
  statement:
 ...
 * ```
 */
export const getProfileActivationsByTimestamp = new PreparedQuery<
  IGetProfileActivationsByTimestampParams,
  IGetProfileActivationsByTimestampResult
>(getProfileActivationsByTimestampIR)
