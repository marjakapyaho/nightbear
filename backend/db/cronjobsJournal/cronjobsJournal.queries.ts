...
const updateIR: any = {
  usedParamSet: {
    previousExecutionAt: true,
    dexcomShareSessionId: true,
    dexcomShareLoginAttemptAt: true,
  },
  params: [
    {
      name: 'previousExecutionAt',
      required: false,
      transform: { type: 'scalar' },
      locs: [{ a: 54, b: 73 }],
    },
    {
      name: 'dexcomShareSessionId',
      required: false,
      transform: { type: 'scalar' },
      locs: [{ a: 104, b: 124 }],
    },
    {
      name: 'dexcomShareLoginAttemptAt',
      required: false,
      transform: { type: 'scalar' },
      locs: [{ a: 161, b: 186 }],
    },
...
const loadIR: any = {
  usedParamSet: {},
  params: [],
  statement: 'SELECT * FROM cronjobs_journal LIMIT 1',
}
