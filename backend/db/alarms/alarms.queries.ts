...
const createAlarmIR: any = {
  usedParamSet: { timestamp: true, situation: true, deactivatedAt: true },
  params: [
    { name: 'timestamp', required: false, transform: { type: 'scalar' }, locs: [{ a: 86, b: 95 }] },
    {
      name: 'situation',
      required: true,
...
const deactivateAlarmIR: any = {
  usedParamSet: { currentTimestamp: true, id: true },
  params: [
    {
    ...
    { name: 'id', required: true, transform: { type: 'scalar' }, locs: [{ a: 95, b: 98 }] },
  ],
  statement:
 ...
 * ```
 */
export const deactivateAlarm = new PreparedQuery<IDeactivateAlarmParams, IDeactivateAlarmResult>(
  deactivateAlarmIR,
)
...
const createAlarmStateIR: any = {
  ...
  params: [
    ...
    { name: 'alarmId', required: true, transform: { type: 'scalar' }, locs: [{ a: 227, b: 235 }] },
    {
      name: 'alarmLevel',
      required: true,
      transform: { type: 'scalar' },
    ...
    { name: 'ackedBy', required: false, transform: { type: 'scalar' }, locs: [{ a: 303, b: 310 }] },
    {
 ...
 * ```
 */
export const createAlarmState = new PreparedQuery<ICreateAlarmStateParams, ICreateAlarmStateResult>(
  createAlarmStateIR,
)
...
const markAlarmAsProcessedIR: any = {
  usedParamSet: { notificationReceipt: true, currentTimestamp: true, id: true },
  params: [
    {
      name: 'notificationReceipt',
      required: false,
    ...
    { name: 'id', required: true, transform: { type: 'scalar' }, locs: [{ a: 159, b: 162 }] },
  ],
  statement:
 ...
 * ```
 */
export const markAlarmAsProcessed = new PreparedQuery<
  IMarkAlarmAsProcessedParams,
  IMarkAlarmAsProcessedResult
>(markAlarmAsProcessedIR)
...
const markAllAlarmStatesAsProcessedIR: any = {
  usedParamSet: { currentTimestamp: true, alarmId: true },
  params: [
    {
      name: 'currentTimestamp',
      required: false,
    ...
    { name: 'alarmId', required: true, transform: { type: 'scalar' }, locs: [{ a: 118, b: 126 }] },
  ],
  statement:
 ...
 * ```
 */
export const markAllAlarmStatesAsProcessed = new PreparedQuery<
  IMarkAllAlarmStatesAsProcessedParams,
  IMarkAllAlarmStatesAsProcessedResult
>(markAllAlarmStatesAsProcessedIR)
...
const getAlarmsIR: any = {
  usedParamSet: { onlyActive: true, alarmId: true, from: true, to: true },
  params: [
    {
      name: 'onlyActive',
      required: false,
    ...
    { name: 'to', required: false, transform: { type: 'scalar' }, locs: [{ a: 1162, b: 1164 }] },
  ],
  statement:
...
const getAlarmStateByAlarmIdIR: any = {
  usedParamSet: { alarmId: true },
  params: [
    { name: 'alarmId', required: false, transform: { type: 'scalar' }, locs: [{ a: 188, b: 195 }] },
  ],
  statement:
 ...
 * ```
 */
export const getAlarmStateByAlarmId = new PreparedQuery<
  IGetAlarmStateByAlarmIdParams,
  IGetAlarmStateByAlarmIdResult
>(getAlarmStateByAlarmIdIR)
