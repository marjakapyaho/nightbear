...
export const detectBadLow = (latestEntry: AnalyserEntry) => latestEntry.bloodGlucose < LOW_LEVEL_BAD
...
export const detectRising = (
  ...
  const predictedSituationIsHighOrBadHigh = isPredictedSituationAnyHighOrMissing(predictedSituation)
  const thereIsNotEnoughCorrectionInsulin =
    insulinOnBoard < RELEVANT_IOB_LIMIT_FOR_HIGH || thereIsTooLittleInsulinForCarbs
