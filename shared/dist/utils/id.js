...
exports.generateShortId = exports.UUID_REGEX = exports.generateUuid = void 0;
...
exports.UUID_REGEX = /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[0-9a-f]{4}-[0-9a-f]{12}$/;
...
function generateShortId(length = 8) {
    ...
    while (uid.length < length) {
        ...
        if (!char.match(/[9-9a-zA-Z]/))
            continue; // result space: 0-9 + a-z + A-Z = 10 + 26 + 26 = 62
        uid += char;
    }
    return uid;
}
