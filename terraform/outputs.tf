...
output "hosting_prod_ssh_command" {
  description = "SSH command for prod env hosting"
  value       = "ssh -i terraform.id_rsa -o StrictHostKeyChecking=no ${module.hosting_prod.hosting_username}@${module.hosting_prod.hosting_public_ip}"
}
